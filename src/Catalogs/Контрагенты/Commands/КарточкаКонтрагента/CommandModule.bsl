...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	КарточкаКонтрагента(ТабДок, ПараметрКоманды);
...
//	ПараметрКоманды - Произвольный - содержит ссылку на объект, для которого вызвана команда печати.
&НаСервере
Процедура КарточкаКонтрагента(ТабДок, ПараметрКоманды)
	Справочники.Контрагенты.КарточкаКонтрагента(ТабДок, ПараметрКоманды);
КонецПроцедуры
